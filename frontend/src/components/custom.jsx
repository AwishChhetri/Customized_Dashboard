        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 mb-4 ">
                  ...
                  <div className="flex flex-col items-center justify-center rounded  h-28 ">
                    ...
                    <p className="">
                    <input type="radio" name='theme1' onClick={()=>setTheme1('pink')}/>PINK<br/>
                    <input type="radio" name='theme1' onClick={()=>setTheme1('yellow')}/>YELLOW<br/>
                    <input type="radio" name='theme1' onClick={()=>setTheme1('orange')}/>ORANGE
                    </p>
                  </div>
                  <div className="flex flex-col items-center justify-center rounded  h-28 ">
                    Choose color for Theme gradient :
                    <p className="">
                    <input type="radio" name='theme2' onClick={()=>setTheme2('pink')}/>PINK<br/>
                    <input type="radio" name='theme2' onClick={()=>setTheme2('yellow')}/>YELLOW<br/>
                    <input type="radio" name='theme2' onClick={()=>setTheme2('orange')}/>ORANGE
                    </p>
                  </div>
                  <div className="flex flex-col items-center justify-center rounded  h-28 ">
                    Choose color for Theme gradient :
                    <p className="">
                    <input type="radio" name='theme3' onClick={()=>setTheme3('pink')}/>PINK<br/>
                    <input type="radio" name='theme3' onClick={()=>setTheme3('yellow')}/>YELLOW<br/>
                    <input type="radio" name='theme3' onClick={()=>setTheme3('orange')}/>ORANGE
                    </p>
                  </div>
                </div>
